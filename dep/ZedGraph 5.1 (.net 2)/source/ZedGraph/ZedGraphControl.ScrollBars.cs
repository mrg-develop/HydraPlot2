...
namespace ZedGraph
{
	...
	#region ScrollBars
		...
		// MOD: para sincronizar panes
        public static void Synchronize( Axis source, Axis dest )
		{
            /*
            ...
            dest._scale._baseTic = source._scale._baseTic;
            */
            dest._scale = source._scale.Clone(dest);
		}
