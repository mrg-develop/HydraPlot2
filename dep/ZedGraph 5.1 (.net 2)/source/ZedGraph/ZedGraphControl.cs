...
*/
	...
	#region Fields: Temporary state variables
        ...
        // Revision: Mrioseco 4/13
        /// <summary>
        /// Internal variable that indicates the control is currently dragging vertical ruler
        /// </summary>
        private bool _isRulerDrag = false;
        ...
        // PATCH: para mover la ruler seleccionada
        private Ruler _rulerInstance = null;
...
*/
        ...
        public void FireZoomEvent(ZedGraphControl sender, ZoomState oldState, ZoomState newState)
        {
            this.ZoomEvent(sender, oldState, newState);
        }
	#endregion
