...
namespace ZedGraph
{
	...
	#region Mouse Events
		...
		protected void ZedGraphControl_MouseDown( object sender, MouseEventArgs e )
		{
            ...
            // PATCH para mover reglas
            if (pane != null &&  (_rulerInstance = pane.Rulers.GetRulerInstanceFromMouse(mousePt)) != null)
            {
                //Console.WriteLine("Click en la ruler");
                _isRulerDrag = true;
            } 
			else if ( pane != null &&
		...
		protected void SetCursor( Point mousePt )
		{
			if ( _masterPane != null )
			{
                ...
                // PATCH para mover regla
                else if (pane != null && pane.Rulers.GetRulerInstanceFromMouse(mousePt) != null)
                {
                    //Console.WriteLine("Mouse bajo la regla!");
		...
		protected void ZedGraphControl_MouseUp( object sender, MouseEventArgs e )
		{
            ...
            if (_masterPane != null && _isRulerDrag )
                    HandleRulerDragFinish(sender, e);
	...
	#region Mouse Wheel Zoom Events
		...
		/// </param>
		public void ZoomScale( Axis axis, double zoomFraction, double centerVal, bool isZoomOnCenter )
		{
	...
	#region Selection Events
        ...
        private Point HandleRulerDrag(Point mousePt)
        {
            //Console.WriteLine("Ruler dragging... (" + mousePt.X + " " + mousePt.Y + ")");
            this.Invalidate(_rulerInstance.Rect);

            _rulerInstance.SetNewPos(mousePt.X, mousePt.Y);
        ...
        private void HandleRulerDragFinish(object sender, MouseEventArgs e)
        {
            _isRulerDrag = false;
            //Console.WriteLine("Ruler drag finish");
        }
