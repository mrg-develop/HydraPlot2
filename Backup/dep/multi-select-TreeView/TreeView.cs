...
/*            
            ...
            {
                // @mrioseco: ignorar cualquier acción cuando se hace click con el botón derecho
                // esto permite manejar el evento OnMouseDown después de manera personalizada
 ...
 * */
            ...
            if (tn == null)
            {
                // @mrioseco: click fuera del tree -> deseleccionar cualquier nodo activo
                this.SelectedNodes.Clear();
                return;
            }
			...
			if (!IsPlusMinusClicked(tn, e))
			{
                ...
                else // @mrioseco: click fuera del área del nodo -> deseleccionar
                {
                    if (tn != null)
                    {
                        if (e.Button != MouseButtons.Right)
